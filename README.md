...
![Proxychains](https://img.shields.io/badge/Proxychains-black?style=flat-square)

**Defence & Monitoring**

![Wazuh](https://img.shields.io/badge/Wazuh_SIEM-005571?style=flat-square)
![iptables](https://img.shields.io/badge/iptables-FF6600?style=flat-square)

**Networking**

![Cisco](https://img.shields.io/badge/Cisco_CCNA-1BA0D7?style=flat-square&logo=cisco&logoColor=white)
`VLANs` · `ACLs` · `802.1Q Trunking` · `VLSM Subnetting` · `DHCP` · `STP` · `SSH Hardening` · `Packet Tracer`
...
![Tails OS](https://img.shields.io/badge/Tails_OS-56347C?style=flat-square)
![VirtualBox](https://img.shields.io/badge/VirtualBox-183A61?style=flat-square&logo=virtualbox&logoColor=white)
![VMware](https://img.shields.io/badge/VMware-607078?style=flat-square&logo=vmware&logoColor=white)
![VPS](https://img.shields.io/badge/VPS_Setup-black?style=flat-square)
...
![Fly.io](https://img.shields.io/badge/Fly.io-7B36ED?style=flat-square)
...
| [**ma-estate-builder.co.uk**](https://maestatebuilder.co.uk) | Next.js · Supabase · Vercel | Before/after galleries, automated email workflows via Resend, custom admin dashboard |
...
Built a **Wazuh SIEM** server from scratch — deployed agents on Kali Linux and Windows, simulated brute-force and malware attacks, and triaged live alerts through the dashboard. All in my bedroom.
...
|---|---|---|
| Introduction to Networks (CCNA 1) | Cisco | ✅ Completed |
| Ethical Hacking | Cisco / Northumbria | ✅ Completed |
| Introduction to Cybersecurity | Cisco | ✅ Completed |
| Python Essentials 1 | Cisco | ✅ Completed |
| AI Fundamentals | IBM | ✅ Completed |
...
> Building and deploying production web applications for clients across construction and estate industries.

**AI Data Annotator** · Outlier AI & RWS Group *(2025 – Present)*
> Annotating and evaluating AI model outputs to improve training data quality.

**Interpreter (Persian–English)** · DA Languages *(Jun 2024 – Present)*
> Professional interpretation across formal settings.
